...
public class P_MenuOrdenados extends javax.swing.JPanel {

    private java.awt.Image fondoImage;

    public P_MenuOrdenados() {
        setOpaque(false);
    ...
    private void initComponents() {
        ...
        jButton1 = new UI.Elements.GlassButton("Ejercicio #4", new java.awt.Color(0, 51, 51), java.awt.Color.WHITE, java.awt.Color.WHITE);
        jButton2 = new UI.Elements.GlassButton("Ejercicio #5", new java.awt.Color(0, 51, 51), java.awt.Color.WHITE, java.awt.Color.WHITE);
        jButton3 = new UI.Elements.GlassButton("Ejercicio #6", new java.awt.Color(0, 51, 51), java.awt.Color.WHITE, java.awt.Color.WHITE);
        jButton4 = new UI.Elements.GlassButton("Atr\u00e1s", new java.awt.Color(0, 51, 51), java.awt.Color.WHITE, java.awt.Color.WHITE);
