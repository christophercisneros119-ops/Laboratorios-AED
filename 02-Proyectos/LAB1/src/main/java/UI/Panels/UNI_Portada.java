...
public class UNI_Portada extends javax.swing.JPanel {
    ...
    private static final int SIDEBAR_W = UI.Elements.SidebarPanel.SIDEBAR_WIDTH;
    private static final java.awt.Font UI_FONT = new java.awt.Font("Segoe UI", java.awt.Font.PLAIN, 12);
    private static final java.awt.Color WHITE_TASKBAR = new java.awt.Color(255, 255, 255, 235);
    private static final java.awt.Color CLOUD = new java.awt.Color(240, 246, 250, 235);

    private java.awt.Image fondoImage;

    private final UI.Elements.TaskbarMenuButton menuButton = new UI.Elements.TaskbarMenuButton();
    private final UI.Elements.SidebarPanel sidebar = new UI.Elements.SidebarPanel();
    private final UI.Elements.DesktopDateWidget dateWidget = new UI.Elements.DesktopDateWidget();
    private final UI.Elements.AboutWindow aboutWindow = new UI.Elements.AboutWindow();
    ...
    private void buildOverlay() {
        ...
        sidebar.getArreglosButton().addMouseListener(new java.awt.event.MouseAdapter() {
            @Override
            public void mouseClicked(java.awt.event.MouseEvent e) {
                navegarA(new UI.Panels.P_MenuArreglos());
            }
        });
    ...
    private void reposition() {
        ...
        aboutWindow.setBounds((w - UI.Elements.AboutWindow.ABOUT_W) / 2 - 25,
                (h - UI.Elements.AboutWindow.ABOUT_H) / 2,
                UI.Elements.AboutWindow.ABOUT_W, UI.Elements.AboutWindow.ABOUT_H);
    ...
    protected void paintComponent(java.awt.Graphics g) {
        ...
        g2.setPaint(new java.awt.LinearGradientPaint(
                ...
                new java.awt.Color[]{new java.awt.Color(4, 12, 16, 30),
        ...
        g2.setPaint(new java.awt.LinearGradientPaint(
                ...
                new java.awt.Color[]{new java.awt.Color(212, 218, 224, 200),
        ...
        g2.setPaint(new java.awt.RadialGradientPaint(
                ...
                new java.awt.Color[]{new java.awt.Color(255, 255, 255, 210),
        ...
        g2.setPaint(new java.awt.RadialGradientPaint(
                ...
                new java.awt.Color[]{new java.awt.Color(255, 255, 255, 220),
        ...
        java.awt.font.TextLayout tl = new java.awt.font.TextLayout("e",
                new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 11), g2.getFontRenderContext());
    ...
    private void initComponents() {
        ...
        titleLabel = new UI.Elements.ShadowLabel();
        divider = new UI.Elements.GradientDivider();
        subtitleLabel = new javax.swing.JLabel();
        professorLabel = new javax.swing.JLabel();
        memberTile1 = new UI.Elements.MemberTile();
        memberTile2 = new UI.Elements.MemberTile();
        memberTile3 = new UI.Elements.MemberTile();
        overlay = new UI.Elements.PassThroughPanel();
    ...
    private UI.Elements.GradientDivider divider;
    private UI.Elements.MemberTile memberTile1;
    private UI.Elements.MemberTile memberTile2;
    private UI.Elements.MemberTile memberTile3;
    private UI.Elements.PassThroughPanel overlay;
    private javax.swing.JLabel professorLabel;
    private javax.swing.JLabel subtitleLabel;
    private UI.Elements.ShadowLabel titleLabel;
