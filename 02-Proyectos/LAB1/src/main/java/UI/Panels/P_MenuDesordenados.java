...
public class P_MenuDesordenados extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jButton1 = new UI.Elements.GlassButton("Ejercicio #1", new java.awt.Color(0, 51, 51), java.awt.Color.WHITE, java.awt.Color.WHITE);
        jButton2 = new UI.Elements.GlassButton("Ejercicio #2", new java.awt.Color(0, 51, 51), java.awt.Color.WHITE, java.awt.Color.WHITE);
        jButton3 = new UI.Elements.GlassButton("Ejercicio #3", new java.awt.Color(0, 51, 51), java.awt.Color.WHITE, java.awt.Color.WHITE);
