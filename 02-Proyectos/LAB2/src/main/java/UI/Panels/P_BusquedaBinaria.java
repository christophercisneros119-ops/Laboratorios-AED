...
public class P_BusquedaBinaria extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jButton1 = new UI.Elements.GlassButton("Guardar", DARK_AQUA, WHITE, WHITE);
        jButton2 = new UI.Elements.GlassButton("Guardar", DARK_AQUA, WHITE, WHITE);
        jButton3 = new UI.Elements.GlassButton("Buscar", DARK_AQUA, WHITE, WHITE);
        jButton4 = new UI.Elements.GlassButton("Atrás", DARK_AQUA, WHITE, WHITE);
