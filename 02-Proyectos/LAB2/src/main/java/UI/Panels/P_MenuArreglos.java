...
public class P_MenuArreglos extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jButton1 = new UI.Elements.GlassButton("Métodos de Ordenación", DARK_AQUA, WHITE, WHITE);
        jButton2 = new UI.Elements.GlassButton("Búsqueda", DARK_AQUA, WHITE, WHITE);
        jButton3 = new UI.Elements.GlassButton("Atrás", DARK_AQUA, WHITE, WHITE);
