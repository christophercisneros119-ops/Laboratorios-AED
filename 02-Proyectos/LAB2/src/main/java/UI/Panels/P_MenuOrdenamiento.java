...
public class P_MenuOrdenamiento extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jButton1 = new UI.Elements.GlassButton("Burbuja", DARK_AQUA, WHITE, WHITE);
        jButton2 = new UI.Elements.GlassButton("Burbuja con Señal", DARK_AQUA, WHITE, WHITE);
        jButton3 = new UI.Elements.GlassButton("Shell", DARK_AQUA, WHITE, WHITE);
        jButton4 = new UI.Elements.GlassButton("Selección Directa", DARK_AQUA, WHITE, WHITE);
        jButton5 = new UI.Elements.GlassButton("Sacudida", DARK_AQUA, WHITE, WHITE);
        jButton6 = new UI.Elements.GlassButton("Baraja", DARK_AQUA, WHITE, WHITE);
        jButton7 = new UI.Elements.GlassButton("Atrás", DARK_AQUA, WHITE, WHITE);
