...
public class P_MenuOrdenados extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jButton1 = new UI.Elementos.GlassButton("Ejercicio #4", new java.awt.Color(0, 51, 51), java.awt.Color.WHITE, java.awt.Color.WHITE);
        jButton2 = new UI.Elementos.GlassButton("Ejercicio #5", new java.awt.Color(0, 51, 51), java.awt.Color.WHITE, java.awt.Color.WHITE);
        jButton3 = new UI.Elementos.GlassButton("Ejercicio #6", new java.awt.Color(0, 51, 51), java.awt.Color.WHITE, java.awt.Color.WHITE);
