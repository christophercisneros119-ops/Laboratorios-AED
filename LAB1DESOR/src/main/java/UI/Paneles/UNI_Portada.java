...
public class UNI_Portada extends javax.swing.JPanel {
    ...
    private void drawTaskbar(java.awt.Graphics2D g2, int w, int h) {
        ...
        drawRightGroup(g2, w, y);
    }
    
    public UI.Elementos.SidebarPanel getSidebar() {
        return sidebar;
    }

    private void drawRightGroup(java.awt.Graphics2D g2, int w, int y) {
        int batteryW = 23;
        int batX = menuButton.getX() - 12 - batteryW;
    ...
    private void drawExplorerE(java.awt.Graphics2D g2, int x, int y) {
        ...
        java.awt.Font eFont = new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 11);
        java.awt.font.TextLayout tl = new java.awt.font.TextLayout("e", eFont, g2.getFontRenderContext());
        java.awt.geom.Rectangle2D eb = tl.getBounds();

        g2.setColor(java.awt.Color.WHITE);
        tl.draw(g2,
                (float) (x + 8 - eb.getCenterX()),
                (float) (cy - eb.getCenterY()));
    }
